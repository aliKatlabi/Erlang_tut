...
%% Tail Recursion TR  "this fella is important concept"
...
%% tail-call optimisation (TCO) :  when the virtual machine sees a function calling itself in a tail position 
%%									(the last expression to be evaluated in a function), it eliminates the current stack frame

%% Last Call Optimisation (LCO) :  last expression to be evaluated in a function body is another function call. When that happens
%%									, as with TCO, the Erlang VM avoids storing the stack frame.

% TCO is special case of LCO
