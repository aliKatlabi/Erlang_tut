...
-spec oh_god(_) -> 'always_does' | 'might_succeed'.
oh_god(N) ->
...
-spec beach(_) -> 'avoid beach' | 'favorable' | 'favorable in the US' | 'scientifically favorable'.
beach(Temperature) ->
	case Temperature of
